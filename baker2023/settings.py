"""
Django settings for baker2023 project.
...
ALLOWED_HOSTS = ['viks-bakes.herokuapp.com', 'localhost', '8000-christoph33o-viksbakery-0kivohjc09k.ws-eu99.gitpod.io']  # noqa
...
WSGI_APPLICATION = 'baker2023.wsgi.application'

# comment out with testing
DATABASES = {
...
#         'default': dj_database_url.parse(os.environ.get('DATABASE_URL'))
#     }
#     print("Connected to Elephant SQL Database")
# else:
#     DATABASES = {
#         'default': {
#             'ENGINE': 'django.db.backends.sqlite3',
